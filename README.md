...
Task pool can also be added (or changed) after TaskManager instantiation, at any point during runtime. Running tasks will not be affected. **TaskManager frees memory after last instance of TasksPool.**
...
void setup()
{
    ...
    manager.setTasksPool(new OtherTasksPool());
